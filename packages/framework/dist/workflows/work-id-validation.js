...
exports.workIdValidationJob = void 0;
const lib_1 = require("@github-actions-workflow-ts/lib");
const dedent = (lines) => lines.join('\n');
function workIdValidationJob(profile) {
    const job = new lib_1.NormalJob('work-id-validation', {
...
exports.workIdValidationJob = workIdValidationJob;
