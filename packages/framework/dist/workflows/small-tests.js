...
exports.smallTestsJob = void 0;
const lib_1 = require("@github-actions-workflow-ts/lib");
const profiles_1 = require("../profiles");
const OUT_OF_POC_SCOPE = (language) => `smallTestsJob: '${language}' branch is out of the PoC scope. ` +
    'Implementable via inner-source contribution — see CONTRIBUTING.md.';
function smallTestsJob(profile) {
    switch (profile.language) {
        ...
        default:
            (0, profiles_1.assertNever)(profile);
    }
}
exports.smallTestsJob = smallTestsJob;
function smallTestsJobPython(profile) {
    const job = new lib_1.NormalJob('small-tests', {
    ...
    const installRun = profile.packageManager === 'uv'
